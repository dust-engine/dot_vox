...
mod tests {
    ...
    const MODIFIED_PALLETE: [u32; 256] = [
      0x00000000, 0xfefefefe, 0xffccffff, 0xff99ffff, 0xff66ffff, 0xff33ffff, 0xff00ffff, 0xffffccff, 0xffccccff, 0xff99ccff, 0xff66ccff, 0xff33ccff, 0xff00ccff, 0xffff99ff, 0xffcc99ff, 0xff9999ff,
      0xff6699ff, 0xff3399ff, 0xff0099ff, 0xffff66ff, 0xffcc66ff, 0xff9966ff, 0xff6666ff, 0xff3366ff, 0xff0066ff, 0xffff33ff, 0xffcc33ff, 0xff9933ff, 0xff6633ff, 0xff3333ff, 0xff0033ff, 0xffff00ff,
      0xffcc00ff, 0xff9900ff, 0xff6600ff, 0xff3300ff, 0xff0000ff, 0xffffffcc, 0xffccffcc, 0xff99ffcc, 0xff66ffcc, 0xff33ffcc, 0xff00ffcc, 0xffffcccc, 0xffcccccc, 0xff99cccc, 0xff66cccc, 0xff33cccc,
      0xff00cccc, 0xffff99cc, 0xffcc99cc, 0xff9999cc, 0xff6699cc, 0xff3399cc, 0xff0099cc, 0xffff66cc, 0xffcc66cc, 0xff9966cc, 0xff6666cc, 0xff3366cc, 0xff0066cc, 0xffff33cc, 0xffcc33cc, 0xff9933cc,
      0xff6633cc, 0xff3333cc, 0xff0033cc, 0xffff00cc, 0xffcc00cc, 0xff9900cc, 0xff6600cc, 0xff3300cc, 0xff0000cc, 0xffffff99, 0xffccff99, 0xff99ff99, 0xff66ff99, 0xff33ff99, 0xff00ff99, 0xffffcc99,
    ...
    fn placeholder(pallete: [u32; 256]) -> DotVoxData {
      DotVoxData {
        version: 150,
        models: vec!(
          Model {
    ...
    fn valid_file_with_no_pallete_is_read_successfully() {
        let result = load("src/resources/placeholder.vox");
        assert!(result.is_ok());
        compare_data(result.unwrap(), placeholder(DEFAULT_PALLETE));
    }
    ...
    fn valid_file_with_pallete_is_read_successfully() {
      ...
      assert!(result.is_ok());
      compare_data(result.unwrap(), placeholder(MODIFIED_PALLETE));
    }
    ...
    fn can_parse_vox_file_without_pallete() {
      ...
      compare_data(models, placeholder(DEFAULT_PALLETE));
    }
    ...
    fn can_parse_vox_file_with_pallete() {
      ...
      assert!(result.is_done());
      let (_, models) = result.unwrap();
      compare_data(models, placeholder(MODIFIED_PALLETE));
    }
    ...
    fn can_parse_voxels_chunk() {
      ...
      vec::are_eq(voxels, vec!(Voxel { x: 0, y: 12, z: 22, i: 226 }, Voxel { x: 12, y: 23, z: 13, i: 226 }));
    }
